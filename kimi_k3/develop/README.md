...
| **P11** | complete | EP=8 baseline: steady 2653.5 ms *(cold; warm is 1912.6 — G50)*, peak 193.6 GiB. Muon step **21.1 %**, AttnRes **0.09 %** — the predicted bottleneck is not one, and the phase rescoped (G42–G45) |
