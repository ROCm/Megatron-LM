...
| --- | --- | --- | --- | --- |
| [-] | T0.1 `PINS.md` (5 SHAs + LICENSES) + fla check | `94a40436c` | 2026-08-27 | **G1 RED**, reason corrected 2026-08-27. All 5 pins + licenses recorded. fla pinned at git `5e02dd3` (0.6.0) and the released `chunk_kda` call **is accepted as written** — the earlier "silently ignored kwargs" reading was wrong and is retracted (D5). Real blocker: the KDA **backward** fails to compile on gfx950 (`chunk_intra.py:395`, TritonAMDGPUPipeline, triton 3.6.0) — D6. PyPI wheel ships no `fla/ops` — D7. Backend stays `eager`; P2–P6 unblocked. See `notes/2026-08-27-fla-signature-check.md` |
