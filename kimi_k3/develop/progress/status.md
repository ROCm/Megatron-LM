...
| [x] | T0.6 AttnRes payload + mixer-temporary sizing | TBD-p0c | 2026-08-27 | **G6 GREEN.** Payload peaks mid-pipeline at **2.8 GB** in flight (stage 3 of 8), 224→896 MB per boundary. One mix at K+1=9: 7.1 GB fwd / 12.2 GB fwd+bwd, 5.15/15.65 ms. Whole model 186 mixes, mean K+1 5.39, **109.6 GiB read per forward**, eager mixer fwd **≈635 ms/microbatch** vs ≈800 ms for all routed-expert GEMMs → recompute mandatory, P11 budget set at ≤64 ms. fp32 tax measured at 2.3× memory / 1.5× time. Report: `results/attn_res.md` |
