...
class TransformerConfig(ModelParallelConfig):
    ...
    moe_flex_dispatcher_backend: Literal['deepep', 'hybridep', 'mori', 'ncclep'] = "deepep"
    """[Experimental] The backend to use for flex token dispatcher. The default is "deepep".
    Options are "deepep", "hybridep", "mori", and "ncclep". Currently only "hybridep" backend supports
